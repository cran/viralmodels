test_that("viraltab() works", {
  ...
  mean <- c(225.9983795, 0.3675989, 237.2771848, 0.2839389, 450.1161467, 0.4542444, 450.1161467, 0.4542444)
  std_err <- c(66.8717322, 0.2398371, 65.4734285, 0.2750490, 256.4233051, 0.0142046, 256.4233051, 0.0142046)
  n <- c(2, 2, 2, 2, 2, 2, 2, 2)
